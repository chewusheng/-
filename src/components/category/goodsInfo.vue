        ...
        <div class="mui-card goods_buy_card">
            <div class="mui-card-header header">
                ...
                <div :class="['heaet_div', heartFlag?'active':'']"  @click="changHeartFlag">
                    <span
                        class="mui-icon-extra mui-icon-extra-heart-filled"
                    ></span>
            ...
            <div class="mui-card-content">
                <div class="mui-card-content-inner content">
                    ...
                    <div class="btn">
                        ...
                        <mt-button type="danger">放入购物车</mt-button>
                    </div>
                </div>
            </div>
        </div>
				...
				<div class="mui-card-content">
					<div class="mui-card-content-inner content">
                        <div>
                         ...
                         <span>
                             卖家服务态度很好，随商品也有附赠的小赠品，感觉买这家的商品很舒服。快递也非常快，接到东西的时候还感到有些意外：怎么这么快？！        
                         </span>
					</div>
				</div>
			</div>
...
export default {
    data() {
        return {
            heartFlag: false,
            goodsInfoData: {
                title: 'Sweet City/都市甜心油性指甲油美甲套装 魅影OL裸色系列7+1礼盒 TC03',
                old_price: '99', new_price: '89'
    ...
    methods : {
        ...
        getGoodsInfoData(){
            this.$http.get('goods/info/'+this.$route.params.id)
            .then(resolve=>{
